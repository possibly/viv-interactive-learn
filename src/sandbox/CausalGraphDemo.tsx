...
// as their "source event" role — the event that turns out to be the root of
// three distinct storyline arcs in the same flat chronicle.
  ...
  return (
    <div className="sifting-diagram">
      ...
      <p className="sifting-desc">
        Three sifting patterns applied to the causal graph — each extracting a different
        storyline from the same <code>write-note</code> event at the root.
      </p>
      ...
      <div className="sifting-branch-connectors">
        {storylines.map((sl) => (
          <div key={sl.name} className="sifting-branch-connector">
            <div className="sifting-branch-line" style={{ borderColor: sl.color }} />
      ...
      <div className="sifting-converge-row">
        <div className="sifting-converge-note">storylines 1 &amp; 2 converge →</div>
...
function StorylineColumn({
  ...
  const edges = storyline.edges.slice(1)
  ...
  return (
    <div className="sifting-column" style={{ borderColor: storyline.color }}>
      <div
        ...
        style={{
          background: storyline.color + '18',
          borderBottomColor: storyline.color + '40',
        }}
      >
        ...
        {nodes.map((node, i) => {
          ...
          return (
            <div key={node.step}>
              ...
              <StorylineEventNode node={node} ev={ev} accentColor={storyline.color} />
            </div>
          )
        })}
      </div>
...
function StorylineEventNode({
  ...
  return (
    <div className="sifting-event-node" style={{ borderColor: accentColor + '55' }}>
